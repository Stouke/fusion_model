...
np.save(os.path.join(base_path, 'images.npy'), images)
np.save(os.path.join(base_path, 'depth_maps.npy'), depth_maps)
np.save(os.path.join(base_path, 'reflectance_maps.npy'), reflectance_maps)

# Save bboxes and labels using pickle
with open(os.path.join(base_path, 'bboxes.pkl'), 'wb') as f:
